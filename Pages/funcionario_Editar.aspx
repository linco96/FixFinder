<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="funcionario_Editar.aspx.cs" Inherits="FixFinder.Pages.funcionario_Editar" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container mt-5">
            ...
            <div class="form-group">
                <asp:Button runat="server" ID="btn_Registro" CssClass="btn btn-primary" OnClick="btn_Registro_Click" Text="Atualizar" />
            </div>
            <div class="form-group">
