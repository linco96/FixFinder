<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orcamento_Comentar.aspx.cs" Inherits="FixFinder.Pages.orcamento_Comentar" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Comentar Orçamento</title>
...
<body>
    <form id="form_Comentar" runat="server">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="container mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                <asp:RadioButtonList runat="server" ID="radio_AvaliacaoServico" RepeatDirection="Horizontal" RepeatLayout="Table" AutoPostBack="false" sytle="display: block" CssClass="w-25 text-center" Enabled="false">
                            ...
                            <div class="form-inline">
                                <h4>Comentário do Cliente</h4>
                            </div>
                            <div class="form-inline mt-1">
                                <span class="w-100 text-left">
                                    <asp:TextBox runat="server" ID="txt_Descrição" CssClass="form-control w-100" TextMode="MultiLine" autocomplete="off" Columns="100" Rows="3" ReadOnly="true"></asp:TextBox>
                                </span>
                            </div>
                            <%--COMENTARIO MECANICO--%>
                            <asp:Panel runat="server" ID="pnl_ComentarioOficinaTitulo" CssClass="form-inline">
                                <h4>Responda o comentário</h4>
                            </asp:Panel>
                            <asp:Panel runat="server" ID="pnl_ComentarioOficina" CssClass="form-inline">
                                <span class="w-100 text-left">
                                    <asp:TextBox runat="server" ID="txt_Comentario" CssClass="form-control w-100" TextMode="MultiLine" autocomplete="off" Columns="100" Rows="3" MaxLength="200" required></asp:TextBox>
                                </span>
                            </asp:Panel>
                        </div>
                        <div class="form-inline mt-1">
